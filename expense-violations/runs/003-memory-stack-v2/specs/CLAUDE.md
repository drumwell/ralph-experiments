...
- **Screenshot it.** Every UI change (Milestones 3+) should be verified visually with Playwright. **Save all screenshots to `screenshots/` directory** — never to the project root.
