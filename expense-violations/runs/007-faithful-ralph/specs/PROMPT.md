# Extend Expense Dashboard — Builder Iteration Prompt
...
- Investigating a bug (e.g., "read server.js and find where violations are detected, check if DUPLICATE_MERCHANT uses a 24h window")
